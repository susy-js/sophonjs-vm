...
var Common = require('sophonjs-common').default;

var _require = require('sophonjs-common/dist/genesisStates'),
 ...
 * @param {Object} [opts={}]
 * @param {Common} [opts.common] - [`Common`](https://octonion.institute/susy-js/sophonjs-common) parameters of the chain
 * @param {Trie} [opts.trie] - a [`merkle-patricia-tree`](https://octonion.institute/susy-js/merkle-patricia-tree) instance
 */
 ...
 * @param {Account} account An [`sophonjs-account`](https://octonion.institute/susy-js/sophonjs-account)
 * instance corresponding to the provided `address`
 */

/**
 * Gets the [`sophonjs-account`](https://octonion.institute/susy-js/sophonjs-account)
...
/**
 * Saves an [`sophonjs-account`](https://octonion.institute/susy-js/sophonjs-account)
 * into state under the provided `address`
 * @memberof StateManager
 * @method putAccount
 * @param {Buffer} address Address under which to store `account`
 * @param {Account} account The [`sophonjs-account`](https://octonion.institute/susy-js/sophonjs-account) to store
...
proto.putContractStorage = function (address, key, value, cb) {
  ...
  self._modifyContractStorage(address, function (storageTrie, done) {
    if (value && value.length) {
      // format input
      var encodedValue = srlp.encode(value);
 ...
 * SIP-161 (https://octonion.institute/susytech/SIPs/blob/master/SIPS/sip-161.md)
 * @memberof StateManager
 ...
 * as defined in SIP-161 (https://octonion.institute/susytech/SIPs/blob/master/SIPS/sip-161.md).
 * @memberof StateManager

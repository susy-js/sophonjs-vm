...
/**
 * Process a transaction. Run the vm. Transfers sof. Checks balances.
 * @method vm.runTx
 * @param opts
 * @param {Transaction} opts.tx a [`Transaction`](https://octonion.institute/susy-go/sophonjs-tx) to run
 ...
 * @param {BN} results.amountSpent the amount of sophy used by this transaction as a `bignum`

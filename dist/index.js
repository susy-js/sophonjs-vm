...
VM.deps = {
  sofUtil: sofUtil,
  Account: require('sophonjs-account'),
  Trie: require('merkle-patricia-tree'),
  srlp: require('sophonjs-util').srlp
   ...
   * @param {Boolean} opts.allowUnlimitedContractSize allows unlimited contract sizes while debugging. By setting this to `true`, the check for contract size limit of 24KB (see [SIP-170](https://git.io/vxZkK)) is bypassed. (default: `false`; ONLY set to `true` during debugging)
